...
*/
typedef union Value { /*8Byte*/
    GCObject *gc;    /*4Byte*/ /* collectable objects */
    void *p;         /*4Byte*/ /* light userdata */
    int b;           /*4Byte*/ /* booleans */
    lua_CFunction f; /*4Byte*/ /* light C functions */
    lua_Integer i;   /*8Byte*/ /* integer numbers */
    lua_Number n;    /*8Byte*/ /* float numbers */
} Value;
